...
public class DeathMessages {
	...
	public String getSpreeMessage(Player player, String damager, Integer deaths){
		...
		String message = ( player.getName() + " has died yet again!" );
		
		if ( deaths == 3 && messages.getString("TRIPLE.message") != null ) {
			
			message = ( fdmFormat(messages.getString("TRIPLE.message"), player) );
